...
- Phase 1 범위: 금융감독원 금융상품통합비교공시 API 기반 상품 조회와 AI 추천 설명
- 서비스 성격: 금융상품 가입 권유가 아닌 참고용 탐색 도구

## 2. 포트폴리오 목표

- 금융 도메인 외부 API 활용 경험 제시
- RAG 기반 AI 추천 서비스 설계 경험 제시
- FastAPI + Next.js 기반 풀스택 MVP 구현 경험 제시
- 금융상품 추천 시 AI 응답 제약 정책을 설계한 사례 제시
- Render Free 티어 환경에서 경량 배포 구조를 설계한 사례 제시
...
- `docs/phase1/flow.md`: 시스템 및 사용자 플로우
